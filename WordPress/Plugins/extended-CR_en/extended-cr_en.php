...
function cr_footer_creds_text() {
	...
	echo 'Copyright &copy; ';
	echo date('Y');
	echo ' &middot; <a style="color:cyan" href="http://climarisk.com" title="Climate Risk management">ClimaRisk</a>';
	echo '</div>';
...
return get_stylesheet_directory_uri().'/images/climarisk_favicon.png';
