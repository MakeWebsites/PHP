...
<table style="width:100%;margin-bottom:2%;line-height:100%">
  <tr>
    <td>Sitio web en ingl&eacute;s de 3 p&aacuteginas utilizando WordPress.</td>
    <td class="no-print"><input name="content" type="checkbox"  disabled="disabled" checked /></td> 
  </tr>
  <tr>
	<td>Dominio dedicado (incluyendo .co.uk opcional).</td>
	<td class="no-print"><input name="metas" type="checkbox" disabled="disabled"  checked /></td>
  </tr>
  <tr>
	<td>Contenido de las webs y organización general optimizados para ingl&eacute;s.</td>
  ...
  <tr>
	<td>Facebook, RSSs, Twitter y otras redes sociales (en ingl&eacute;s).</td>
...
<table style="width:100%;margin-bottom:2%;line-height:100%">
  ...
  <tr>
	<td>Dise&nacute;o de logos, figuras y/o contenido multimedia (en ingl&eacute;s) (<span style="color:#008A2F;font-weight: bold;">325€</span>):</td>
  ...
  <tr>
	<td>Comercio electr&oacute;nico (en ingl&eacute;s) (<span style="color:#008A2F;font-weight: bold;">450€</span>):</td>
  ...
  <tr>
	<td>Cuentas en redes sociales (en ingl&eacute;s) por un a&nacute;o (<span style="color:#008A2F;font-weight: bold;">275€</span>):</td>
...
$emailt = '?subject=Diseño%20sitio%20inglés%20&amp;';
$emailt .= 'body=Estimado%20Diseñador%20Make-Website%20%3A%0A%0AEstoy%20interesado%20en%20su%20diseño%20de%20sitio%20en%20inglés%20por%20un%20precio%20de%20%C2%A3';
$emailt .= $price;
$emailt .= '.%20%0APara%20';
$emailt .= $_SESSION['npages'];
$emailt .= '%20páginas.';
	if ($_SESSION['newpics'])
	$emailt .= '%20%0AAdemás%2C%20desearía%20diseñar%20nuevos%20logos%20y%20figuras%20en%20inglés.';
	 if ($_SESSION['ecommerce'])
	 $emailt .= '%20%0AMe%20gustaría%20incluir%20plugins%20para%20comercio%20electrónico%20en%20inglés.';
	 if ($_SESSION['smedia'])
	 $emailt .= '%20También%20quisiera%20cuentas%20en%20redes%20sociales%20en%20inglés.'; 
